...
const { createGodown, getGodownInventory } = require('../controllers/godownControllers');

const router = express.Router();

router.get('/stats', protect, authorize('admin'), getAdminStats);
router.get('/users', protect, authorize('admin'), getAllUsers);
router.post('/godowns', protect, authorize('admin'), createGodown);
...
router.get('/godowns/:id/inventory', protect, authorize('admin'), getGodownInventory);
